...
$dosen = mysqli_query($connection, "SELECT * FROM dosen WHERE nip='$nip'");
          ...
          <form action="edit_dosen.php" method="post">
            <div class="control-group">
              <div class="form-group floating-label-form-group controls mb-0 pb-2">
                <label>NIP</label>
                <input class="form-control" id="nip" name="nip" type="text" value='<?php echo $nip; ?>' required="required" disabled>
