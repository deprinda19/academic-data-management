...
<?php
  ...
  if (isset($_POST['Submit'])){
    ...
    $mahasiswa = mysqli_query($connection, "INSERT INTO mahasiswa(nrp,nama,alamat,jenis_kelamin,tanggal_lahir,id_program_studi) VALUES ('$nrp','$nama','$alamat','$jenis_kelamin','$tanggal_lahir','$id_program_studi')");
