                  ...
                  <table class="table table-stripped">
                    ...
                    <tbody>
                      ...
                      while ($data_dosen = mysqli_fetch_array($dosen)) {
                        ...
                        echo "<td> <a class='btn btn-success' href='edit_dosen.php?nip=$data_dosen[nip]'>Edit</a> <a class='btn btn-danger' href='delete_dosen.php?nip=$data_dosen[nip]'><i class='fas fa-trash fa-fw'></i>Delete</a></td></tr>";
                      }
                        ?>
                    </tbody>
                  </table>
                  ...
                  <table class="table table-stripped">
                    ...
                    <tbody>
                      ...
                      while ($data_mahasiswa = mysqli_fetch_array($mahasiswa)) {
                        ...
                        echo "<td> <a class='btn btn-success' href='edit_mahasiswa.php?nrp=$data_mahasiswa[nrp]'>Edit</a> <a class='btn btn-danger' href='delete_mahasiswa.php?nrp=$data_mahasiswa[nrp]'><i class='fas fa-trash fa-fw'></i>Delete</a></td></tr>";
                      }
                        ?>
                    </tbody>
                  </table>
